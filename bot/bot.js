...
module.exports = function setUpBot() {
    ...
    client.on('message', message => {
        ...
        if (/([\Wa-zNnΝ]N|[\Wa-zNnΝ]Ñ|(^|\W)[nNñÑΝNnṄṅṆṇṈṉṊṋŃńŅņŇňǸǹÑñȠƞŊŋƝŉǊǋǌȵℕ№])([^a-zA-Z]? *)*[oO0οΟØøǾǿᶱÖöȪȫÓoóÒòÔôỐốỒồỔổỖỗỘộǑǒŐőŎŏȎȏȮȯȰȱỌọƟɵƠơỚớỜờỠỡỢợỞởỎỏŌōṒṓṐṑÕõȬȭṌṍṎṏǪǫȌȍO̩o̩Ó̩ó̩Ò̩ò̩Ǭǭᴏoᴼᴑ]($|\W|p|[ØøǾǿᶱÖöȪȫÓóÒòÔoôỐốỒồỔổỖỗỘộǑǒŐőŎŏȎȏȮȯȰȱỌọƟɵƠơỚớỜờỠỡỢợỞởỎỏŌōṒṓṐṑÕõȬȭṌṍṎṏǪǫȌȍO̩o̩Ó̩ó̩Ò̩ò̩ǬǭᴏᴼoᴑoO0οΟ])/g.test(message.content) || (message.author.tag.endsWith('4990') && /[^a-zA-Z ,.?\s!áéíóú]/.test(message.content))) {
            message.delete();
        }
